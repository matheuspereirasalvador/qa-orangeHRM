...
Funcionalidade: Gestão de Anexos e Fotos de Perfil
    ...
    Esquema do Cenario: Bloqueio de arquivos maliciosos e extensões proibidas
        ...
        Exemplos:
            ...
            | script.php       | Extensão de script proibida |
            | virus.exe        | Executável proibido         |
            | fake_image.jpg   | Arquivo .exe renomeado (Magic Number Check) |