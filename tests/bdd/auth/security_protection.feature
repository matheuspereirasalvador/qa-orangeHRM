...
Funcionalidade: Proteção e Segurança (Security)
  ...
  Cenario: Bloqueio de conta após 3 tentativas falhas
  ...
  @RN-AUTH-01 @Security
  Cenario: Tentativa de login durante período de bloqueio
    Dado que o usuário "Admin" está bloqueado temporariamente
    Quando eu tento logar com a senha CORRETA "Admin123!"
    Então devo ver a mensagem "Credenciais inválidas ou conta bloqueada"
    E não devo conseguir acessar o Dashboard

  @RF-AUTH-02 @Smoke
  Cenario: Encerramento de sessão (Logout) com sucesso
  ...
  @RN-AUTH-07 @Security
  Cenario: Bloqueio de acesso via histórico do navegador após logout
